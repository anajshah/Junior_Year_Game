...
@onready var collision_polygon_2d_3: CollisionPolygon2D = $killzone/CollisionPolygon2D3
...
func _ready() -> void:
	...
	random_int = randi_range(0, 1) # 1 to 100
	print(random_int)
	if random_int == 1:
		...
		animated_sprite_2d.play("y=e^x")
		collision_polygon_2d_3.set_deferred("disabled", true)
	timer.start()
...
func _on_timer_timeout() -> void:
	if random_int == 1:
		...
		collision_polygon_2d_3.set_deferred("disabled", false)
	timer_2.start()
